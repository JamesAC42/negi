...
function getDarkThemeVariables(): Record<string, string> {
  return {
    ...
    "--bg3": "#1b2130",
    "--app-bg-opacity": "0.78",
    "--center-bg-tint": "rgba(11, 13, 16, 0.48)",
    "--center-bg-vignette": "rgba(11, 13, 16, 0.78)",
    "--line": "#1f2633",
    "--line2": "#2b3445",
    "--panel-bg0": "rgba(11, 13, 16, 0.82)",
    "--panel-bg1": "rgba(16, 19, 26, 0.84)",
    "--panel-bg2": "rgba(21, 25, 35, 0.8)",
    "--panel-bg3": "rgba(27, 33, 48, 0.78)",
    "--tx0": "#e9eef5",
    "--tx1": "#aab3c5",
    "--tx2": "#69748c"
  };
...
function getLightThemeVariables(): Record<string, string> {
  return {
    ...
    "--bg3": "#e4eadf",
    "--app-bg-opacity": "0.74",
    "--center-bg-tint": "rgba(238, 241, 237, 0.48)",
    "--center-bg-vignette": "rgba(238, 241, 237, 0.76)",
    "--line": "#d8dfd4",
    "--line2": "#c1ccbd",
    "--panel-bg0": "rgba(238, 241, 237, 0.82)",
    "--panel-bg1": "rgba(248, 250, 246, 0.84)",
    "--panel-bg2": "rgba(238, 242, 236, 0.8)",
    "--panel-bg3": "rgba(228, 234, 223, 0.78)",
    "--tx0": "#151a17",
    "--tx1": "#344038",
    "--tx2": "#5f6d64"
  };
